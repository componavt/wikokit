 ...
 * @version 1.4b1 (Released June 20, 2001) changed by a. shapiro to work with touchgraphwikibrowser and win 95, but with hack to work on NT from christoph drieschner 2002/06/02!!!
 */
public class BrowserLauncher {
     ...
     *
     * Originally was set to "\"\"", but setting to "" mysteriously made things work
     * on windows98 with IE5.5. --Alex Shapiro (11/18/2001)
     */
    private static String THIRD_WINDOWS_PARAMETER = "";//"\"\""; //depends on jvm: "\"\"" for NT (see case stmt)//christoph drieschner 2002/06/02
	...
	public static void openURL(String url) throws IOException {
		...
		switch (jvm) {
			...
			case MRJ_3_1:
				...
				break;
		    case WINDOWS_NT:
                        System.out.print("Running on NT, using Christoph Drieschners Hack for Third_parameter, see BrowserLauncher.java");
