...
CREATE TABLE IF NOT EXISTS `image` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `filename` VARCHAR(255) NOT NULL COMMENT 'Filename using underscores.',
  `size` INT(8) UNSIGNED NOT NULL COMMENT 'File size in bytes.',
  `width` INT(5) UNSIGNED NOT NULL COMMENT 'Image width, in pixels.',
  `height` INT(5) UNSIGNED NOT NULL COMMENT 'Image height, in pixels.',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `image_meaning` (
  ...
  `meaning_id` INT(10) UNSIGNED NOT NULL,
  `image_caption` VARCHAR(511) NOT NULL)
ENGINE = InnoDB
