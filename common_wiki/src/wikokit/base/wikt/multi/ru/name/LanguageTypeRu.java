...
public class LanguageTypeRu extends LanguageTypeLocal {
    ...
    public static final LanguageTypeLocal akm = new LanguageTypeRu("Бо", LanguageType.akm);
    ...
    public static final LanguageTypeLocal auj = new LanguageTypeRu("Ауджила", LanguageType.auj);
    ...
    public static final LanguageTypeLocal goe = new LanguageTypeRu("Гонгду", LanguageType.goe);
    ...
    public static final LanguageTypeLocal hne = new LanguageTypeRu("Чхаттисгархи", LanguageType.hne);
    ...
    public static final LanguageTypeLocal kem = new LanguageTypeRu("Кемак", LanguageType.kem);
    ...
    public static final LanguageTypeLocal tati = new LanguageTypeRu("Тати", LanguageType.tati);
    ...
    public static final LanguageTypeLocal tkd = new LanguageTypeRu("Токодеде", LanguageType.tkd);
    ...
    public static final LanguageTypeLocal trp = new LanguageTypeRu("Кокборок", LanguageType.trp);
    ...
    public static final LanguageTypeLocal xbo = new LanguageTypeRu("Булгарский", LanguageType.xbo);
    ...
    public static final LanguageTypeLocal ysr = new LanguageTypeRu("Сиреникский", LanguageType.ysr);
