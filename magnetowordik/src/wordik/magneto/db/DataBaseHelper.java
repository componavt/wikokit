...
import wordik.magneto.JoinerFiles;
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/wordik.magneto/databases/";

    //private static String DB_NAME = "enwikt_mean_semrel";	//"enwikt_mean_semrel_sqlite.mp3";
    private static String DB_NAME = "enwikt"; //"enwikt_mean_semrel_sqlite";
   ...
   /**
    ...
    private void copyDataBase() throws IOException{
    	...
    	InputStream my_input = context.getAssets().open(DB_NAME);
